...
<body>
    <form id="form1" runat="server">
        <div>
            ...
            <br />
            Queue 3 Run time:
            <asp:TextBox ID="txtQ3" runat="server" Width="16px" OnTextChanged="txtQ3_TextChanged" onkeypress ="document.getElementById('txtQ4').innerHTML = this.value;" ReadOnly="False" AutoPostBack="True">1</asp:TextBox>
            <br />
...
&nbsp;
            ...
            <br />
            Queue 4 Run time:
            <asp:TextBox ID="txtQ4" runat="server" Width="16px" OnTextChanged="txtQ4_TextChanged" ReadOnly="False" AutoPostBack="True">1</asp:TextBox>
            <br />
...
&nbsp;&nbsp;&nbsp;
        ...
        <br />
        <asp:Button ID="Button1" runat="server" OnClick="Button1_Click" Text="End Scheduler" />
    </form>
</body>
</html>
